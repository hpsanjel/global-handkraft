			...
			<aside className="hidden w-64 shrink-0 flex-col bg-[#1B365D] lg:flex">
				<div className="flex items-center gap-2.5 px-5 py-5">
					...
					<div className="min-w-0">
						...
						<p className="text-xs font-medium uppercase tracking-[0.16em] text-stone-700">My Account</p>
					</div>
				</div>
						...
						<DropdownMenu>
							<DropdownMenuTrigger asChild>
								<button type="button" className="flex items-center gap-2 rounded-lg py-1.5 pl-1.5 pr-2.5 text-sm font-medium text-slate-700 transition hover:bg-slate-100">
									<span className="flex h-8 w-8 items-center justify-center rounded-full bg-linear-to-br from-[#1B365D] to-brand-green text-xs font-semibold text-white">{getInitials(user)}</span>
